    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/api.totalBalanceResponse"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.dailyExpenseTrendResponse"
                            }
                        }
                    },
                    "400": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/api.expenseByCategoryResponse"
                            }
                        }
                    },
                    "400": {
        ...
        "/transaction": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Number of items per page (min: 5, max: 100)",
                        "name": "page_size",
                        "in": "query",
                        "required": true
                    }
        ...
        "/users/google/callback": {
            "get": {
                ...
                "responses": {
                    "307": {
                        "description": "Redirect ke frontend dengan error message",
                        "schema": {
                            "type": "string"
                        }
                    }
        ...
        "/users/google/login": {
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "auth_url dan state untuk redirect",
                        "schema": {
                            "type": "object",
                            "additionalProperties": {
                                "type": "string"
